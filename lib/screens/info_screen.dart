        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 20),
              Text('Universidad Autónoma de Asunción - Facultad Ciencias y Tecnología', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold),textAlign: TextAlign.center,),
              SizedBox(height: 20),
              Text('Materia: Programación para Dispositivos Móviles', style: TextStyle(fontSize: 18),textAlign: TextAlign.center,),
              SizedBox(height: 10),
